...
from bitcoin.bip39 import (
    find_candidates, mnemonic_from_bytes, mnemonic_is_valid, mnemonic_to_bytes, mnemonic_to_seed)
...
class Bip39Test(TestCase):
    def test_bip39(self):
        for [seed, exp_mnemonic, hex_seed, xprv] in VECTORS:
            ...
            act_xkey = HDKey.from_seed(mnemonic_to_seed(act_mnemonic, password="TREZOR"))
    ...
    def test_invalid_checksum(self):
        words = "ivory canyon lend simple system regret test cool clip foam answer abandon"
        self.assertFalse(mnemonic_is_valid(words))
    ...
    def test_find_candidates_happy(self):
        prefix = "a"
        exp_candidates = ['abandon', 'ability', 'able', 'about', 'above', 'absent', 'absorb', 'abstract', 'absurd', 'abuse']

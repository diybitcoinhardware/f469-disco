                               ...
                               uint8_t *buf)
{
  ...
  ccd_descriptor->bcdCCID           = (buf[12] << 8) + buf[11];
  ccd_descriptor->nMaxSlotIndex     = *(uint8_t  *) (buf + 13);
  ccd_descriptor->bVoltageSupport   = *(uint8_t  *) (buf + 14);
  ccd_descriptor->dwProtocols       = *(uint8_t  *) (buf + 15);
  ccd_descriptor->dwDefaultClock    = dw2i(buf + 9, 10);
  ccd_descriptor->dwMaxiumumClock   = dw2i(buf + 9, 14);
  ccd_descriptor->bNumClockSupported = *(uint8_t  *) (buf + 27);
  ccd_descriptor->dwDataRate         = dw2i(buf + 9, 19);
  ccd_descriptor->dwMaxDataRate      = dw2i(buf + 9, 23);
  ccd_descriptor->bNumDataRatesSupp  = *(uint8_t  *) (buf + 36);
  ccd_descriptor->dwMaxIFSD          = dw2i(buf + 9, 28);
  ccd_descriptor->dwSyncProtocols    = dw2i(buf + 9, 32);
  ccd_descriptor->dwMechanical       = dw2i(buf + 9, 36);
  ccd_descriptor->dwFeatures         = dw2i(buf + 9, 40);
  ccd_descriptor->dwMaxCCIDMessageLength = dw2i(buf + 9, 44);

...
Example: [source code](../../../examples/addresses.py), [try online](https://diybitcoinhardware.github.io/f469-disco/simulator/index.html?script=https://raw.githubusercontent.com/diybitcoinhardware/f469-disco/master/examples/addresses.py)

## `bitcoin.transaction`

Example: [source code](../../../examples/transactions.py), [try online](https://diybitcoinhardware.github.io/f469-disco/simulator/index.html?script=https://raw.githubusercontent.com/diybitcoinhardware/f469-disco/master/examples/transactions.py)

## `bitcoin.psbt` - Partially Signed Bitcoin Transactions

Example: [source code](../../../examples/psbt.py), [try online](https://diybitcoinhardware.github.io/f469-disco/simulator/index.html?script=https://raw.githubusercontent.com/diybitcoinhardware/f469-disco/master/examples/psbt.py)
